        ...
        {Array.from({ length: 5 }, (_, i) => {
          ...
          return (
            <button
              ...
              onMouseLeave={() => isAuthenticated && setHovered(0)}
              className={`text-2xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded ${
